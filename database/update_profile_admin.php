<?php
    ...
    $query_obtain_userPsw = "SELECT psw FROM user WHERE user_id = '$adminID'";
    ...
    if (password_verify($oldPsw, $dbOldPsw )) {
        ...
        if ($newPsw != $repeatPsw) {
            ...
            $query= "UPDATE user SET full_name='$newName', username='$newUsername', psw='$encryptedPsw' WHERE user_id = '$adminID'";
